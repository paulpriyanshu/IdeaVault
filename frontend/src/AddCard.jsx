...
function AddCard({title,description}) {
  const [isSelected,setSelected]=useState(false)
    ...
    return (
      ...
      <div style={{width:450,height:300,overflowWrap: 'break-word', wordWrap: 'break-word'}} className=" todo-container bg-yellow-100 rounded-xl shadow-md overflow-auto  cursor-pointer">
